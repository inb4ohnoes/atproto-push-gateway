...
func TestFormatNotification(t *testing.T) {
	tests := []struct {
		...
		{"like with display name", "like", "Alice", "alice.test", "", "Alice liked your post", "Open Aery to view it."},
		{"like falls back to handle", "like", "", "alice.test", "", "alice.test liked your post", "Open Aery to view it."},
		{"like falls back to Someone", "like", "", "", "", "Someone liked your post", "Open Aery to view it."},
		{"repost", "repost", "Alice", "", "", "Alice reposted your post", "Open Aery to view it."},
		{"reply without text", "reply", "Alice", "", "", "Alice replied to your post", "Open Aery to view it."},
		{"reply with text", "reply", "Alice", "", "Great post!", "Alice replied to your post", "Great post!"},
		{"mention without text", "mention", "Alice", "", "", "Alice mentioned you", "Open Aery to view it."},
		{"mention with text", "mention", "Alice", "", "Hey @bob check this", "Alice mentioned you", "Hey @bob check this"},
		{"quote without text", "quote", "Alice", "", "", "Alice quoted your post", "Open Aery to view it."},
		{"quote with text", "quote", "Alice", "", "This is so true!", "Alice quoted your post", "This is so true!"},
		{"like with text", "like", "Alice", "", "Cool post", "Alice liked your post", "Cool post"},
		{"repost with text", "repost", "Alice", "", "Cool post", "Alice reposted your post", "Cool post"},
		{"follow ignores postText", "follow", "Alice", "", "ignored", "Alice followed you", "Open Aery to view their profile."},
		{"follow", "follow", "Alice", "", "", "Alice followed you", "Open Aery to view their profile."},
		{"like-via-repost", "like-via-repost", "Alice", "", "", "Alice liked a post you reposted", "Open Aery to view it."},
		{"like-via-repost with text", "like-via-repost", "Alice", "", "Cool post", "Alice liked a post you reposted", "Cool post"},
		{"repost-via-repost", "repost-via-repost", "Alice", "", "", "Alice reposted a post you reposted", "Open Aery to view it."},
